...
#define STRING_CONFIG_H_AUTHOR "Legath" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Climber7"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.20,  17.90 }
    #define DEFAULT_Ki_LIST {   1.08,   1.12 }
    #define DEFAULT_Kd_LIST { 114.00, 71.60 }
  #else
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 150,150 }
